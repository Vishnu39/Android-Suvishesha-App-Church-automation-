...
public class Kalotsavamdetail extends ListActivity {
    int ids[];
    int Total=0;
    @Override
    ...
    void getUsers(){
        ...
        String url = "http://suviseshabhavan.com/suvi/android/kalodetail.php?kid="+Appconstants.kaloid;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Kalotsavamdetail.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        showUser(myResponse);
                        //  startMainpage();
